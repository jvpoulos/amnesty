...
dens.plot <- ggplot(dens.dat, aes(x=cutoff, y=y)) + 
  ...
  scale_y_continuous(name="p-value",breaks=c(0,0.05,0.10,1),labels=c("0","0.05","0.10","1")) + ggtitle(paste0("1860 slaveholders, N=",format(nrow(slaveholders.60.rd), nsmall=0, big.mark=","))) + theme(plot.title = element_text(hjust = 0.5))
